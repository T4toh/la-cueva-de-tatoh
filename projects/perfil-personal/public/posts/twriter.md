# tWriter - Escribiendo como un gordo barbudo

## Preámbulo

Vengo escribiendo novelas hace un rato y el flujo siempre era el mismo cuatreto:
...
Para meter toda la cadena en un mismo lugar armé **tWriter**: editor + conversor RAE + chequeo gramatical con LanguageTool + export EPUB. Una sola app, un solo flujo.
...
- Chequeo de gramática integrado con LanguageTool.
...
Está acá: [github.com/T4toh/tWriter](https://github.com/T4toh/tWriter). Sigue en alpha — lo uso a diario para mi propia escritura pero todavía falta para que sea cómodo para alguien más.
